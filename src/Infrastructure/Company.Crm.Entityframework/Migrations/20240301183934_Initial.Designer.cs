...
namespace Company.Crm.Entityframework.Migrations
{
    ...
    [Migration("20240301183934_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Company.Crm.Domain.Entities.Task", b =>
                {
                    b.HasOne("Company.Crm.Domain.Entities.Employee", "EmployeeFK")
                        .WithMany()
                        .HasForeignKey("EmployeeUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Company.Crm.Domain.Entities.Request", "RequestFK")
                        .WithMany()
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Company.Crm.Domain.Entities.Lst.TaskStatus", "TaskStatusFK")
                        .WithMany("Tasks")
